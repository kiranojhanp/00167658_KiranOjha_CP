                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                        Visitor:&nbsp;&nbsp;
                                        <input type="radio" name="is_admin" style="cursor: pointer;" value="0" checked>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        Owner:&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="is_admin" style="cursor: pointer;" value="1">
                                </div>

                                {{-- <label for="is_admin" class="col-md-4 col-form-label text-md-right">{{ __('User type') }}</label>

                            <div class="col-md-6">
                                <input id="is_admin" type="text" class="form-control @error('is_admin') is-invalid @enderror"
